...
class Main():
    ...
    def __init__(self):
        ...
        self.height = 600
        self.FPS = 75
        self.bg = pygame.image.load("backgrounds/bg.png")
        self.start = True
        self.clock = pygame.time.Clock()
        self.icon = pygame.image.load("backgrounds/card.png")
        ...
        self.chips = Chips()
        self.spritesheet = Spritesheet("spritesheet/spritesheet.png")
        self.mouse = Mouse()
        self.mouse_bool = False
        pygame.font.init()
        self.my_font = pygame.font.Font("fonts/LCALLIG.ttf", 25)
        self.count_font = pygame.font.Font("fonts/LCALLIG.ttf", 20)
                                ...
                                if  rect[0].collidepoint(pygame.mouse.get_pos()):
                                    if self.choices[self.choice_rects.index(rect)] == "Hit":
                                        ...
                                        #This is in case the user pressed the "New hand" button at the end of a game
                                         ...
                                         self.player.user_bet, self.player.user_balance, self.chips.chip_op_bool =  self.chips.bet_sequence(self.screen,self.player.user_balance,self.buttons, self.mouse_bool, self.mouse)
