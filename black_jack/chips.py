...
class Chips():
    ...
    def __init__(self):
        ...
        self.chips_img = [pygame.image.load(chip) for chip in ["chips/white.png","chips/blue.png","chips/pink.png","chips/purple.png","chips/yellow.png","chips/red.png",]]
        ...
        self.bet_bg = pygame.image.load("backgrounds/betting.png")
        self.chip_op_bool = True
        self.init_bet = True
        pygame.font.init()
        self.balance_font = pygame.font.Font("fonts/LCALLIG.ttf", 30)
    ...
    def bet_sequence(self, screen, user_balance, buttons, mouse_bool, mouse):
        betting = True
        user_bet = 0
        while betting:
